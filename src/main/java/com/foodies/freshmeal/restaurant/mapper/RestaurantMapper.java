 ...
 *
 * <p>
 * The mapper does not perform repository access, business validation,
 * sequence generation, image resolution, or lifecycle operations.
 * </p>
 *
 * ============================================================================
 */
...
public class RestaurantMapper {
     ...
     *
     * <p>
     * Server-managed fields such as restaurantNumber, status, availability,
    ...
    public RestaurantEntity toEntity(CreateRestaurantInputDTO request) {
        ...
        RestaurantEntity entity = (RestaurantEntity) EntityFactory.createEntity(EntityName.RE);
        ...
        entity.setPhoneNumber(
                PhoneNumber.builder()
                        .value(request.getRestaurantRequest().getPhoneNumber())
                        .build());

        entity.setEmailAddress(
                EmailAddress.builder()
                        .value(request.getRestaurantRequest().getEmailAddress())
                        .build());
        ...
        entity.setLogoImageId(request.getr);
    ...
    public RestaurantListResponse toListResponse(
        ...
        return RestaurantListResponse.builder()
                .id(entity.getId())
                .restaurantNumber(entity.getRestaurantNumber())
                .restaurantName(entity.getRestaurantName())
                .description(entity.getDescription())
                .cuisineTypes(
                        DisplayOptionMapperUtil.fromSet(
                                entity.getCuisineTypes()))
                .status(
     ...
     */
    public RestaurantDetailsResponse toDetailsResponse(
            RestaurantEntity entity) {
        ...
        return RestaurantDetailsResponse.builder()
                ...
                .emailAddress(
                        entity.getEmailAddress() != null
                                ? entity.getEmailAddress().getValue()
                                : null)
