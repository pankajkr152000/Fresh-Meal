 ...
 *
 * <p>
 * DTO transformation remains delegated to
 * {@link RestaurantBranchMapper}. Persistence operations remain delegated to
 ...
 */
@Service
public class RestaurantBranchServiceImpl
        implements IRestaurantBranchService {
     ...
     * @param databaseSequenceService
     *                                   database sequence service
     * @param restaurantBranchRepository
     *                                   restaurant branch repository
     * @param restaurantRepository
     *                                   restaurant repository
     * @param restaurantBranchMapper
     *                                   restaurant branch mapper
     */
     ...
     *
     * <p>
     * A dedicated Restaurant Branch sequence is used to generate both the
     * internal database identifier and external business branch number.
     * </p>
     *
    ...
    public IServiceOutput<RestaurantBranchDetailsResponse> getById(
        ...
        RestaurantBranchEntity branch = restaurantBranchRepository
                .findActiveById(request.getBranchId())
                .orElseThrow(
    ...
    public IServiceOutput<List<RestaurantBranchListResponse>> getAll(
        ...
        List<RestaurantBranchListResponse> responses = branches.stream()
     ...
     *
     * <p>
     * A Restaurant Branch cannot exist independently from its parent
     * Restaurant.
     * </p>
     *
