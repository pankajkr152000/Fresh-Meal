package com.foodies.freshmeal.exception.util;
...
import com.foodies.freshmeal.date.AppCalendar;
import com.foodies.freshmeal.ruleContext.IRuleContext;
import com.foodies.freshmeal.ruleContext.impl.RuleContext;
...
public class DataExceptionUtils {
	...
	public static Set<String> getBypassErrorByConcessionCd(String ruleCd, Map<String, Serializable> objectMap,
		...
		ruleContext.setRunDate(AppCalendar.getInstance().getBusinessDate());
