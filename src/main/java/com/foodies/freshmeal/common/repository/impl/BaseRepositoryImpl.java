 ...
 *
 * <p>
 * This implementation extends Spring Data's {@link SimpleMongoRepository}
 * while providing enterprise persistence features including:
 * </p>
 *
 * <ul>
 ...
 * @since 1.0
 */
public class BaseRepositoryImpl<T extends ABaseEntity, ID>
    ...
    public BaseRepositoryImpl(
            final MongoEntityInformation<T, ID> entityInformation,
    ...
    private Criteria activeCriteria() {
        ...
        return Criteria.where(EntityFieldConstants.DELETED_FLAG)
                .is(RepositoryConstants.ACTIVE);
    }
    ...
    private Criteria deletedCriteria() {
        ...
        return Criteria.where(EntityFieldConstants.DELETED_FLAG)
                .is(RepositoryConstants.DELETED);
    }
    ...
    /**
     * Creates a query for retrieving a logically deleted entity by its
     * identifier.
     *
     * @param id Entity identifier.
     *
    ...
    private Query buildQuery(
        ...
        final Query query = (sourceQuery == null)
                ? new Query()
                : Query.of(sourceQuery);
     ...
     *
     * <p>
     * This update performs a logical delete without replacing the
     * MongoDB document.
     * </p>
     *
     ...
     * @return Mongo update.
     */
    private Update buildSoftDeleteUpdate(
            final RepositoryContext repositoryContext) {

        return createUpdate()

                .set(
                        EntityFieldConstants.DELETED_FLAG,
                        RepositoryConstants.DELETED)

                .set(
                        EntityFieldConstants.DELETED_AT,
                        repositoryContext.currentDateTime())

                .set(
                        EntityFieldConstants.DELETED_BY,
                        repositoryContext.currentUser())

                .set(EntityFieldConstants.UPDATED_AT,
                        repositoryContext.currentDateTime())

                .set(EntityFieldConstants.UPDATED_BY,
                        repositoryContext.currentUser());
    }
     ...
     * @return Mongo update.
     */
    private Update buildRestoreUpdate(
            final RepositoryContext repositoryContext) {

        return createUpdate()

                .set(EntityFieldConstants.DELETED_FLAG,
                        RepositoryConstants.ACTIVE)

                .set(EntityFieldConstants.DELETED_AT,
                        null)

                .set(EntityFieldConstants.DELETED_BY,
                        null)
    ...
    public T softDelete(
        ...
        final T entity = mongoOperations.findAndModify(
                query,
                update,
    ...
    public T restore(
        ...
        if (entity == null) {
            ...
            LOGGER.warn(
                    "Failed to restore {} with id [{}]. Entity not found or already active.",
