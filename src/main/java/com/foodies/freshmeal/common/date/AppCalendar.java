 ...
 * ============================================================================
 *
 * Central Business Calendar for the FreshMeal application.
 *
 * <p>
 * This class acts as the single source of truth for obtaining the current
 * business date and time throughout the application.
 * </p>
 *
 * <p>
 * <b>IMPORTANT:</b>
 * Never use {@code LocalDate.now()}, {@code LocalTime.now()} or
 * {@code LocalDateTime.now()} directly in the application.
 *
 * Always use this class so that:
 *
 * • Business Time can be controlled centrally.
 * • Future timezone changes require modification in only one place.
 * • Future Business Date implementation (banking style) becomes easy.
 * • Testing becomes much simpler by mocking this class.
 * </p>
 *
 * ============================================================================
 *
 ...
 *
 * <pre>
 * LocalDate today = AppCalendar.getBusinessLocalDate();
 *
 * LocalTime now = AppCalendar.getBusinessLocalTime();
 *
 * LocalDateTime current = AppCalendar.getBusinessLocalDateTime();
 * </pre>
 *
 * ============================================================================
 *
...
public final class AppCalendar {
    ...
    public static LocalDate getBusinessLocalDate() {
        ...
        return getBusinessLocalDateTime().toLocalDate();
    }

    /**
     * Returns the current business time.
     *
     * @return current business time
     */
    public static LocalTime getBusinessLocalTime() {

        return getBusinessLocalDateTime().toLocalTime();
    }

    /**
     * Returns the current business date and time.
     *
     * <p>
     * This is the only place where the application accesses the system clock.
     * Every module should obtain the current date/time through this method.
     * </p>
     *
     * @return current business date-time
     */
    public static LocalDateTime getBusinessLocalDateTime() {

        return LocalDateTime.now(DateConstants.DEFAULT_ZONE);
    }
