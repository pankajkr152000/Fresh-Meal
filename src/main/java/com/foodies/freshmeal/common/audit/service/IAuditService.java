...
public interface IAuditService {
	 ...
	 */
	void logSuccess(String api, MethodType method, Object request, Object response, Integer statusCode, Long executionTimeMs);

	/**
	 * Create and save audit log for failed API execution.
	 */
	void logFailure(String api, MethodType method, Object request, Exception exception, Integer statusCode, Long executionTimeMs);
