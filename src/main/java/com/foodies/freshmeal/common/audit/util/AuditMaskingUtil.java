...
public final class AuditMaskingUtil {
	 ...
	 *
	 * For simple Java values such as String, Number, Boolean, Enum and Date/Time
	 * values, reflection is not required.
	 *
	...
	/**
	 * Determines whether the object is a simple value that does not require
	 * reflection-based field inspection.
	 *
