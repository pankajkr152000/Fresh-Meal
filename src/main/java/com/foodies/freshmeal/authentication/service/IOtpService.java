...
public interface IOtpService {
     ...
     *
     * <p>
     * The OTP is persisted only in hashed form. The raw OTP is returned as part
     * of {@link OtpGenerationResult} so that the authentication layer can send
     * it through {@code IEmailService}.
     * </p>
     *
     * <p>
     * The result also contains the persistent verification number of the
     * generated OTP record. This identifier is subsequently used to mark the
     * exact OTP record as successfully dispatched.
     * </p>
     *
     * @param userNumber
     ...
     */
    OtpGenerationResult generateEmailVerificationOtp(
            String userNumber,
            String email,
     ...
     *
     * <p>
     * The implementation enforces expiration, maximum attempts, and the
     * one-hour lockout period after all attempts are exhausted.
     * </p>
     *
     * @param userNumber
     *                       user business identifier
     ...
     *                       email address associated with the user
     * @param otp
     *                       OTP supplied by the user
     * @param serviceContext
     *                       current service context
     * @return verification result containing verification status and remaining
     *         attempts
     */
    OtpVerificationResult verifyEmailVerificationOtp(
            String userNumber,
            String email,
            String otp,
            IServiceContext serviceContext);
     ...
     *
     * <p>
     * The persistent verification number is used to identify the exact OTP
     * record generated for the email delivery operation. The raw OTP is
     * intentionally not required for this operation.
     * </p>
     *
     * @param verificationNumber
     *                           persistent identifier of the generated OTP record
     * @param serviceContext
     *                           current service context
     */
    void markEmailVerificationOtpSent(
     ...
     *                       current service context
     */
    void revokeActiveEmailVerificationOtp(
            String userNumber,
            IServiceContext serviceContext);
}