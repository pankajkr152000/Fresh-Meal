 ...
 * ============================================================================
 *
 * Defines the business operations responsible for FreshMeal authentication
 * and authentication-related account security workflows.
 *
 * <p>
 * Authentication establishes and maintains the authenticated identity of a
 * user. Authorization concerns such as roles, permissions, and resource
 * access decisions are intentionally outside this contract.
 * </p>
 *
 ...
 * <li>Token generation and validation implementation details remain inside
 * the token/security components.</li>
...
public interface IAuthenticationService {
     ...
     */
    IServiceOutput<RegisterResponse> register(
            IServiceInput<RegisterInputDTO> input);
     ...
     */
    IServiceOutput<VerifyEmailOtpResponse> verifyEmailOtp(
            IServiceInput<VerifyEmailOtpInputDTO> input);
     ...
     *
     * <p>
     * Resend frequency and maximum resend limits are enforced by the
     ...
     */
    IServiceOutput<RegisterResponse> resendEmailOtp(
            IServiceInput<ResendEmailOtpInputDTO> input);
     ...
     */
    IServiceOutput<LoginResponse> login(
            IServiceInput<LoginInputDTO> input);
     ...
     */
    IServiceOutput<TokenResponse> refreshToken(
            IServiceInput<RefreshTokenInputDTO> input);
     ...
     */
    IServiceOutput<Boolean> logout(
            IServiceInput<LogoutInputDTO> input);

    /**
     * Changes the password of the currently authenticated user.
     *
     * <p>
     * The current password must be successfully verified before the new
     ...
     */
    IServiceOutput<Boolean> changePassword(
            IServiceInput<ChangePasswordInputDTO> input);
     ...
     */
    IServiceOutput<Boolean> forgotPassword(
            IServiceInput<ForgotPasswordInputDTO> input);
     ...
     */
    IServiceOutput<Boolean> resetPassword(
            IServiceInput<ResetPasswordInputDTO> input);
}