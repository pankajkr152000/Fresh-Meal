 ...
 * <ul>
 * <li>
 * <b>Token level</b> - revokes one individual JWT using its
 * {@code jti} ({@code tokenId}).
 * </li>
 * <li>
 * <b>Session level</b> - revokes the complete authentication session using
 * {@code sessionId}.
 * </li>
 * </ul>
 *
...
public interface ITokenRevocationService {
     ...
     * @return {@code true} when the token has been revoked; otherwise
     *         {@code false}
     */
